...
function getGravityEffect() {
    ...
    if (quarkup1) effect = nanDestroyer(player.quarks.gravity.max(1).log(logAmount).log10().pow("0.8").plus(1))
    else effect = nanDestroyer(player.quarks.gravity.max(1).log(logAmount).pow("0.8").plus(1))
